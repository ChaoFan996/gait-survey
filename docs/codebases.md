...
- `assets/public-codebases-statistics.pdf` is the fixed manuscript figure, 3.5 × 6.3 inches, with embedded Times New Roman and vector graphics. It retains its own snapshot date if the interactive data are later refreshed.
