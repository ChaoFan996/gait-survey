...
function renderCloud(){
  cloudTerms=termFrequency(filtered);const host=$('word-cloud'),width=host.clientWidth||690,height=host.clientHeight||184;
  if(!cloudTerms.length){host.innerHTML='<div class="cloud-empty">No summary terms for this selection.</div>';$('cloud-caption').textContent='Try another selection to explore the vocabulary.';return;}
